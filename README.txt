...
This repository presents **Frontier Mart Sales Analysis**, a powerful business intelligence project designed to uncover sales trends, identify top-performing products, and drive data-driven decisions. The dashboard visualises **3 years of retail sales data** using **Power BI**, offering a detailed breakdown of orders, sales, profits, and much more!
...
* 📁 CSV files as a data source (or connect your database)
* 🎨 Custom colour theme (Dark Blue, Yellow, White)
...
* 📚 **Data Portfolio**: Showcase BI skills in a real-world business context
